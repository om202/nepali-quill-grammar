      ...
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='flex justify-center items-center space-x-12 mb-8'>
          <div className='flex flex-col items-center text-center group'>
            ...
            <span className='text-sm font-semibold text-gray-700 group-hover:text-gray-900 transition-colors duration-300'>Fix Errors</span>
          </div>
          <div className='flex flex-col items-center text-center group'>
            ...
            <span className='text-sm font-semibold text-gray-700 group-hover:text-gray-900 transition-colors duration-300'>Improve Style</span>
          </div>
          <div className='flex flex-col items-center text-center group'>
            ...
            <span className='text-sm font-semibold text-gray-700 group-hover:text-gray-900 transition-colors duration-300'>Save Work</span>
          </div>
          <div className='flex flex-col items-center text-center group'>
            ...
            <span className='text-sm font-semibold text-gray-700 group-hover:text-gray-900 transition-colors duration-300'>Type Faster</span>
          </div>
        </div>
        ...
        <div className='text-center'>
          <p className='text-base text-gray-600 leading-relaxed'>
            Write better Nepali instantly. <span className='font-semibold text-indigo-700'>Sign up free</span> to start using Vyakaranly.
          </p>
        </div>
      </div>
    </div>
